-- =============================================================================
-- 03_integrations.sql — consolidated from: 11_integrations.sql, 12_external_applications.sql, 13_site_assets.sql
-- =============================================================================


-- >>> BEGIN 11_integrations.sql
...
-- <<< END 11_integrations.sql

-- >>> BEGIN 12_external_applications.sql
...
-- <<< END 12_external_applications.sql

-- >>> BEGIN 13_site_assets.sql
