...
assert.strictEqual(start.pythonSupportsRapidOCR(3, 13), true);
assert.strictEqual(start.pythonSupportsLegacyRapidOCR(3, 12), true);
assert.strictEqual(start.pythonSupportsLegacyRapidOCR(3, 13), false);
