...
Completed sprint freeze reports and repository migration notes. Kept for audit trail — see [README.md](README.md) and live code for current behavior. Historical mega-doc: [ARCHITECTURE.md](ARCHITECTURE.md).
