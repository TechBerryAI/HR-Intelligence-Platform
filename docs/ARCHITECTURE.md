...
> **Authority:** Historical deep dive. Prefer live code (`apps/backend/`, `apps/frontend/`) and [DEVELOPMENT.md](DEVELOPMENT.md) when this file disagrees. End-user guides: [user-manual/](user-manual/README.md).
