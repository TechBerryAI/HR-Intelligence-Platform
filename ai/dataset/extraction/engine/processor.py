...
from dataset.factory.inspector.format_detection import FormatRegistry
from dataset.factory.inspector.hashing import hash_file

from dataset.extraction.engine.config import EngineConfig
from dataset.extraction.extractors.registry import ExtractorRegistry
from dataset.extraction.models import DocumentJob, ExtractionResult
...
class DocumentProcessor:
    ...
    def _doc_output_dir(self, job: DocumentJob) -> Path:
        from dataset.extraction.shared.utils import document_id_from_hash
