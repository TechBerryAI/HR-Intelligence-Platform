...
from dataset.proposals.engine.config import build_config  # noqa: E402
from dataset.proposals.engine.orchestrator import ProposalEngine  # noqa: E402
...
def _setup_logging(verbose: bool) -> logging.Logger:
    ...
    return logging.getLogger("dataset.proposals")
