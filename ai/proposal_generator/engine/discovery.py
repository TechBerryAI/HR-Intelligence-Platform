...
from proposal_generator.models.proposal import SilverDocumentJob
from proposal_generator.shared.constants import DOC_TYPE_TASK_MAP, REQUIRED_SILVER_FILES
