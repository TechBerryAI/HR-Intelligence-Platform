...
from document_engine.engine.config import build_config  # noqa: E402
from document_engine.engine.orchestrator import ExtractionEngine  # noqa: E402
...
def _setup_logging(verbose: bool):
    ...
    return logging.getLogger("document_engine")
