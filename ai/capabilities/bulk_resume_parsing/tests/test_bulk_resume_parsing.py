"""Capability package tests for bulk_resume_parsing."""
...
def test_capability_loads() -> None:
    ...
    assert package.id == "bulk_resume_parsing"
...
def test_capability_has_prompt_template() -> None:
    ...
    assert "resume_parser_v1" in package.prompt_text or "bulk_resume_parsing" in package.prompt_text
